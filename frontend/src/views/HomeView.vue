        ...
        <div class="flex justify-between h-20 items-center">
          ...
          <div class="flex items-center gap-4">
            <div v-if="user" class="flex items-center gap-4">
              ...
              <button @click="$router.push('/dashboard')" class="bg-blue-100 text-blue-900 px-5 py-2 rounded-lg font-bold hover:bg-blue-200 transition">
                Mans Panelis
              </button>
            </div>
            <div v-else class="flex items-center gap-3">
              ...
              <button @click="$router.push('/register')" class="bg-blue-600 text-white px-5 py-2.5 rounded-lg font-bold hover:bg-blue-700 shadow-lg hover:shadow-xl transition transform hover:-translate-y-0.5">
                Reģistrēties
              </button>
            </div>
          </div>
    ...
    <header class="bg-blue-900 relative overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto px-4 py-24 sm:px-6 lg:px-8 relative z-10 text-center">
        ...
        <p class="text-xl text-blue-100 mb-10 max-w-2xl mx-auto">
          No santehnikas līdz programmēšanai. Pievieno savu darbu bez maksas vai atrodi klientus saviem pakalpojumiem.
        </p>
