        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                ...
                <div class="md:pr-10 lg:pr-16">
                    <p class="text-xs font-bold uppercase text-center tracking-widest text-emerald-600 mb-8">
                ...
                <div class="mt-14 md:mt-0 md:pl-10 lg:pl-16 md:border-l border-gray-200">
                    <p class="text-xs font-bold uppercase text-center tracking-widest text-gold mb-8">
