...
const seekerSteps = [
    {
        ...
        desc: 'Apraksti nepieciešamo darbu, norādi budžetu un atrašanās vietu.',
    },
    {
        icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z',
        title: 'Saņem piedāvājumus',
        desc: 'Meistari piesakās uz tava sludinājumu un nosūta savus piedāvājumus.',
    },
    {
        icon: 'M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z',
        title: 'Izvēlies un pieņem',
        desc: 'Salīdzini piedāvājumus, apskata profilus un izvēlies piemērotāko meistaru.',
    },
];
...
const masterSteps = [
    {
        ...
        desc: 'Pievieno savu pieredzi, portfeli un pakalpojumus, kas tevi padara izcilu.',
    },
    {
        icon: 'M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z',
        title: 'Atrodi darbus',
        desc: 'Pārlūko darba sludinājumus un piesakies tieši tiem, kas tevi interesē.',
    },
    {
        icon: 'M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z',
        title: 'Sāc strādāt',
        desc: 'Vienojies ar klientu caur platformas tērzēšanu un sāc projektu.',
    },
];
</script>
    ...
    <section class="py-16 bg-white border-t border-gray-100">
        <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8">
                <h2 class="text-2xl font-bold text-navy">Ka tas darbojas?</h2>
                <p class="text-sm text-gray-500 mt-1">Tris vienkārši soli, lai sāktu</p>
            </div>
            ...
            <div v-show="active === 'seeker'" class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                    ...
                    <div>
                        <div class="text-xs font-bold text-emerald-500 uppercase tracking-wide mb-1">{{ i + 1 }}. solis</div>
