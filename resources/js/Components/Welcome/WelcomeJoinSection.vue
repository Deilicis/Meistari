            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div class="bg-navy rounded-2xl overflow-hidden flex flex-col">
                    ...
                    <div class="p-8 flex-grow">
                        ...
                        <p class="text-white/50 text-sm leading-relaxed mb-6">Reģistrējies, izveido sava darba profilu un saņem pieprasījumus no klientiem, kas meklē tieši tavus pakalpojumus.</p>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden flex flex-col">
                    ...
                    <div class="p-8 flex-grow">
                        ...
                        <p class="text-gray-500 text-sm leading-relaxed mb-6">Publicē sludinājumu, apraksti nepieciešamo darbu un saņem piedāvājumus no pārbaudītiem meistariem tavā apkaimē.</p>
                        <Link v-if="canRegister" :href="route('register')"
