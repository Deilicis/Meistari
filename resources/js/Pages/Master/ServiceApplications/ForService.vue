...
<template>
    <Head :title="serviceTitle ? t('applications.for_service_page_title', { title: serviceTitle }) : t('applications.for_service_title')" />
        ...
        <div class="bg-navy">
            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
                ...
                >
                    ...
                    {{ t('applications.for_service_back') }}
                </Link>
                <div class="flex items-center gap-3">
                    <InboxArrowDownIcon class="w-6 h-6 text-gold" />
                    <div>
                        <h1 class="text-2xl font-extrabold text-white tracking-tight">
                            {{ serviceTitle || t('applications.for_service_title') }}
                        </h1>
                        <p class="text-white/50 text-sm mt-0.5">
                            <span class="text-gold font-semibold">{{ t('applications.for_service_count', applications.length) }}</span>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="py-6">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <div v-if="filtered.length === 0" class="bg-white rounded-2xl border-2 border-dashed border-gray-200 p-16 text-center">
                    ...
                    <h3 class="text-base font-semibold text-gray-900 mb-1">{{ t('applications.empty_filter_title') }}</h3>
                    <p class="text-sm text-gray-400">{{ t('applications.empty_filter_desc') }}</p>
                </div>
